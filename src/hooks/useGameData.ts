...
import type { RouteId, PracticeMode, RouteCombo, SimilarRouteIndexes } from '../types/game';
...
export const useGameData = (
  ...
  previousPracticeMode: PracticeMode,
  setPreviousPracticeMode: (mode: PracticeMode) => void,
  ...
  useEffect(() => {
    ...
    loadGameData(practiceMode).then((data) => {
      ...
      let gameIndex: number | null = null;
